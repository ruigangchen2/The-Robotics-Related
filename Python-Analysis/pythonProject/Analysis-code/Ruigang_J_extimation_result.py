...
data1 = pd.read_csv("./Data/different_rotation_inertia_curve/60_newinertia_59.94.csv")
start_point1 = 391
end_point1 = 1114
...
data2 = pd.read_csv("./Data/different_rotation_inertia_curve/60_newinertia_60.3.csv")
start_point2 = 391
end_point2 = 1120
...
data3 = pd.read_csv("./Data/different_rotation_inertia_curve/60_newinertia_60.12.csv")
start_point3 = 391
end_point3 = 1120
...
data4 = pd.read_csv("./Data/different_rotation_inertia_curve/60_newinertia_61.38.csv")
start_point4 = 390
end_point4 = 1120
...
data5 = pd.read_csv("./Data/different_rotation_inertia_curve/60_newinertia_61.56.csv")
start_point5 = 393
end_point5 = 1120
