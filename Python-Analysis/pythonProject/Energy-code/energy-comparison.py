...
data = pd.read_excel("../Data/20240125/20240125_200_80.xlsx")
...
plt.plot(time_fitted[start_point:end_point], -Elastic_Power[start_point:end_point]/np.pi*180, 'r--', label='Input')
plt.plot(time_fitted[start_point:end_point], Kinetic_Power[start_point:end_point]/np.pi*180, 'b', label='Mechanical')
plt.legend(ncol=2)
