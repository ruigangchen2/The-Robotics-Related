...
plt.axvline(x=0.019, c="k", ls="--", lw=1.5)
plt.axvline(x=0.115, c="k", ls="--", lw=1.5)
plt.axvline(x=0.479, c="k", ls="--", lw=1.5)
plt.axvline(x=0.538, c="k", ls="--", lw=1.5)
plt.ylabel(r'$\theta$ [$^\circ$]',loc="center")
plt.yticks([0,200])
plt.xticks([])
plt.subplot(fig_num, 2, 3)
...
plt.ylabel('Power [W]',loc="center",labelpad=15.5)
plt.yticks([0,1])
plt.ylim([-0.7,1.6])
plt.xticks([])
plt.subplot(fig_num, 2, 5)
...
plt.axvline(x=0.538, c="k", ls="--", lw=1.5)
plt.xlabel('Time [s]')
plt.ylabel('Energy [mJ]',loc="center")
plt.legend(ncol=2)
plt.yticks([0,100])
plt.ylim([-10,150])
...
plt.yticks([0,200])
plt.xticks([])
plt.axvline(x=0.304, c="k", ls="--", lw=1.5)
